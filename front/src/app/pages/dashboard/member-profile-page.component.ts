    ...
    <div class="space-y-6">
      <div>
        <h2 class="text-4xl font-bold text-foreground">
          {{ site.localize(profileTitle) }}
        </h2>
        <p class="text-lg text-muted-foreground">
          {{ site.localize(profileIntro) }}
        </p>
      </div>
        ...
        <div class="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <form class="surface-card p-8 space-y-6" (ngSubmit)="save()">
            <div class="grid gap-5 md:grid-cols-2">
              <div>
                <label class="mb-2 block font-semibold">Nom</label
                ><input [(ngModel)]="form.nom" name="nom" class="input-shell" />
              </div>
              <div>
                <label class="mb-2 block font-semibold">Prenom</label
                ><input
                  [(ngModel)]="form.prenom"
                  name="prenom"
                  class="input-shell"
              ...
              <div>
                <label class="mb-2 block font-semibold">Sexe</label
                ><select
                  [(ngModel)]="form.sexe"
                  name="sexe"
                  class="select-shell"
              ...
              <div>
                <label class="mb-2 block font-semibold">Date de naissance</label
                ><input
              ...
              <div>
                <label class="mb-2 block font-semibold">Lieu de naissance</label
                ><input
              ...
              <div>
                <label class="mb-2 block font-semibold">Telephone</label
                ><input
              ...
              <div>
                <label class="mb-2 block font-semibold">CIN</label
                ><input [(ngModel)]="form.cin" name="cin" class="input-shell" />
              </div>
              <div>
                <label class="mb-2 block font-semibold">Passeport</label
                ><input
              ...
              <div class="md:col-span-2">
                <label class="mb-2 block font-semibold">Adresse</label
                ><textarea
            ...
            <div class="grid gap-5 md:grid-cols-2">
              <div>
                <label class="mb-2 block font-semibold">Grade</label
                ><input
                  [(ngModel)]="form.grade"
                  name="grade"
                  class="input-shell"
              ...
              <div>
                <label class="mb-2 block font-semibold">ORCID</label
                ><input
                  [(ngModel)]="form.orcid"
                  name="orcid"
                  class="input-shell"
              ...
              <div>
                <label class="mb-2 block font-semibold">Institution</label
                ><select
                ...
                >
                  ...
                  @for (
                    item of profile()?.references?.institutions || [];
                    track item.id
                  ) {
              ...
              <div>
                ...
                >
                  <option value="">Selectionner</option>
                  @for (
                    item of profile()?.references?.equipesRecherche || [];
                    track item.id
                  ) {
                    <option [ngValue]="item.id">{{ item.nom }}</option>
                  }
              ...
              <div>
                <label class="mb-2 block font-semibold">Dernier diplome</label
                ><input
              ...
              <div>
                <label class="mb-2 block font-semibold">Date d'obtention</label
                ><input
              ...
              <div class="md:col-span-2">
                <label class="mb-2 block font-semibold"
                  >Etablissement du diplome</label
                ><input
            ...
            <div class="grid gap-5">
              <div>
                <label class="mb-2 block font-semibold"
                  >Denomination du laboratoire</label
                ><input
              ...
              <div>
                <label class="mb-2 block font-semibold"
                  >Universite du laboratoire</label
                ><input
              ...
              <div>
                <label class="mb-2 block font-semibold"
                  >Responsable du laboratoire</label
                ><input
          ...
          <div class="space-y-6">
            <div class="surface-card p-8">
              ...
              <div class="mt-6 space-y-3 text-base text-muted-foreground">
                ...
                <div>
                  Role:
                  <span class="font-semibold text-foreground">{{
                    profile()?.utilisateur?.role || 'MEMBRE'
                  }}</span>
                </div>
                <div>
                  Statut:
                  <span class="font-semibold text-foreground">{{
                    profile()?.utilisateur?.statut
                  }}</span>
                </div>
                <div>
                  Articles personnels:
                  <span class="font-semibold text-foreground">{{
                    memberArticles()?.articles?.length || 0
                  }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="surface-card p-8">
              <h3 class="text-3xl font-bold text-foreground">
                Attestation doctorant
              </h3>
              <p class="mt-4 text-muted-foreground">
                @if (
                  profile()?.utilisateur?.doctorat?.attestation?.disponible
                ) {
...
export class MemberProfilePageComponent implements OnInit {
  ...
  readonly profileIntro = {
    fr: 'Mettez à jour vos informations personnelles et scientifiques.',
    en: 'Update your personal and scientific information.',
    ar: 'حدّث معلوماتك الشخصية والعلمية.',
  };
  ...
  async save() {
    ...
    const errors = validateRegistrationPayload(this.form, {
      ...
      hasExistingAttestation: Boolean(
        ...
        this.profile()?.utilisateur.doctorat?.attestation?.disponible,
      ),
    });
