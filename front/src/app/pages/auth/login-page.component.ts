      ...
      <div class="auth-shell">
        <div class="auth-panel">
          ...
          <p class="mt-4 max-w-2xl text-base text-muted-foreground lg:text-lg">
            Connectez-vous avec votre compte institutionnel pour gerer vos
          ...
          <div
            class="mt-6 flex flex-col gap-3 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between"
          >
            <a
        ...
        <aside class="auth-aside p-6 lg:p-8">
          ...
          <h2 class="mt-6 text-3xl font-semibold text-white">
            Un point d'entree unique pour le cycle scientifique
          </h2>
          <p class="mt-4 text-sm text-white/72">
            L'espace membre centralise les soumissions d'articles, la moderation
            et les actualites internes dans une interface unique.
          </p>
          ...
          <div class="mt-8 space-y-3">
            <div class="auth-aside__feature">
              ...
              <div class="mt-2 text-sm text-white/72">
                Suivez vos brouillons, soumissions et publications depuis le
                tableau de bord.
              </div>
            </div>
            <div class="auth-aside__feature">
              ...
              <div class="mt-2 text-sm text-white/72">
                Les administrateurs peuvent traiter les inscriptions et
                attribuer les roles sans changer de contexte.
              </div>
            </div>
            <div class="auth-aside__feature">
              <div class="text-sm font-semibold text-white">
              ...
              <div class="mt-2 text-sm text-white/72">
                Les chefs de laboratoire arbitrent les articles et publient les
                actualites depuis la meme interface.
              </div>
            </div>
          </div>
        </aside>
