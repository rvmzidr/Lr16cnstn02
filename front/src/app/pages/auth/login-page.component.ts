      ...
      <div class="auth-shell">
        <div class="auth-panel">
          ...
          <form class="mt-8 space-y-4" (ngSubmit)="submit()">
            <div>
              <label class="mb-1.5 block text-sm font-medium text-foreground/80">Email institutionnel</label>
              <div class="relative">
            ...
            <div>
              <label class="mb-1.5 block text-sm font-medium text-foreground/80">Mot de passe</label>
              <div class="relative">
        ...
        <aside class="auth-aside p-6 lg:p-8">
          <div class="tag-chip border-white/10 bg-white/10 text-white">Gestion des articles</div>
